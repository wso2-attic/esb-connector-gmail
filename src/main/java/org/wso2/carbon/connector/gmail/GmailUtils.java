...
public final class GmailUtils {
     ...
     * @throws ConnectException   if the folder does not exist
     */
     ...
     * @throws MessagingException if any failure occur while deleting messages
     * @throws ConnectException   if no messages are fetched to delete
     */
     ...
     * @param term                Search term
     * @param responseElementName Name of the response element name
     * @throws MessagingException if any failure occur while reading messages
     * @throws ConnectException   if no messages are fetched to read
     */
     ...
     * @throws MessagingException if any failure occur while setting labels
     * @throws ConnectException   if no messages are fetched to set labels
     */
     ...
     *
     * @param messagesArray     Array of {@link Message}
     ...
     * @throws ConnectException      if the batch number is not a positive integer
     */
     ...
     *
     * @param session        Mail {@link Session}.
     * @param subject        Subject of the mail.
     ...
     * @throws ConnectException   if invalid attachment IDs are provided.
     * @throws MessagingException
     * @throws IOException
     */
     ...
     * @param transport The {@link SMTPTransport} through which the message should be
     *                  sent
     * @throws MessagingException as a result of failures in message transportation
     */
     ...
     * given.
     *
     * @param folderName name of the {@link IMAPFolder}
     * @param store      {@link IMAPStore} instance where the folder is located
     * @return the folder
     * @throws MessagingException as a result of the failures occur while getting the folder
     * @throws ConnectException   if the folder is null
     */
     ...
     * @param multipart            input {@link Multipart} to process
     ...
     * @throws IOException as a result of the failures occur while getting the byte
